...
class DataAugmentor(object):
    ...
    def random_world_flip(self, data_dict=None, config=None):
        ...
        gt_boxes, points, points_lidar = data_dict['gt_boxes'], data_dict['points'], data_dict.get('points_lidar', None)
        for cur_axis in config['ALONG_AXIS_LIST']:
            assert cur_axis in ['x', 'y']
            gt_boxes, points, points_lidar = getattr(augmentor_utils, 'random_flip_along_%s' % cur_axis)(
                gt_boxes, points, points_lidar
            )

        data_dict['gt_boxes'] = gt_boxes
        data_dict['points'] = points
        if points_lidar is not None:
    ...
    def random_world_scaling(self, data_dict=None, config=None):
        ...
        gt_boxes, points, points_lidar = augmentor_utils.global_scaling(
            data_dict['gt_boxes'], data_dict['points'], data_dict.get('points_lidar', None), config['WORLD_SCALE_RANGE']
        )
    ...
    def random_world_translation(self, data_dict=None, config=None):
        ...
        for cur_axis in config['ALONG_AXIS_LIST']:
            ...
            gt_boxes, points, points_lidar = getattr(augmentor_utils, 'random_translation_along_%s' % cur_axis)(
                gt_boxes, points, points_lidar, offset_range,
            )
